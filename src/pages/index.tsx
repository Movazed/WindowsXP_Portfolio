...
export default function Home() {
  ...
  const handleOpenGitHub = () => {
    window.open("https://github.com/Movazed", "_blank", "noreferrer");
  };
  ...
  const handleOpenCodeforces = () => {
    window.open("https://codeforces.com/profile/Movazed", "_blank", "noreferrer");
  };

  const handleOpenCodeChef = () => {
    window.open("https://www.codechef.com/users/movazed5", "_blank", "noreferrer");
  };

  const handleOpenLeetCode = () => {
    window.open("https://leetcode.com/u/Movazed/", "_blank", "noreferrer");
  };

  return (
    <>
      <Head>
        <title>Arya&apos;s Personal Website - Home Page</title>
      ...
      <main className={styles.main}>
        ...
        >
          ...
          */}
          ...
          <DesktopIcon
            appID={8}
            doubleClick={handleOpenCodeforces}
            title="My Codeforces"
            img={cf}
          />
          <DesktopIcon
